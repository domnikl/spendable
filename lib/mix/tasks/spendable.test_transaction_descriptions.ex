    ...
    case Transactions.create_transaction(transaction_attrs) do
      {:ok, transaction} ->
        ...
        mock_gocardless_transaction = %{
          ...
          transaction_amount: %{
            amount: "-3500",  # String format as from API
            currency: "EUR"
          },
          ...
          purpose_code: "OTHR",
          remittance_information_unstructured: "Order #ORD-2025-001: Electronics purchase - Laptop accessories"
        }
        ...
        {name, iban} =
          if amount < 0 do
            {mock_gocardless_transaction.debtor_name, mock_gocardless_transaction.debtor_account.iban}
          else
            {mock_gocardless_transaction.creditor_name, mock_gocardless_transaction.creditor_account.iban}
          end
