defmodule SpendableWeb.Components.Alert do
  @moduledoc """
  SpendableWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
