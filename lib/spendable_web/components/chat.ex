defmodule SpendableWeb.Components.Chat do
  @moduledoc """
  `SpendableWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
