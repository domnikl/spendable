defmodule SpendableWeb.Components.CheckboxCard do
  @moduledoc """
  The `SpendableWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
