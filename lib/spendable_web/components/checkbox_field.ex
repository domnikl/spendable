defmodule SpendableWeb.Components.CheckboxField do
  @moduledoc """
  SpendableWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
