defmodule SpendableWeb.Components.Clipboard do
  @moduledoc """
  The `SpendableWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
