defmodule SpendableWeb.Components.Combobox do
  @moduledoc """
  The `SpendableWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
