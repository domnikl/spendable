defmodule SpendableWeb.Components.Divider do
  @moduledoc """
  The `SpendableWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `SpendableWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
