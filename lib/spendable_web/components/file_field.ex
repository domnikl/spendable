defmodule SpendableWeb.Components.FileField do
  @moduledoc """
  The `SpendableWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import SpendableWeb.Components.Progress, only: [progress: 1]
