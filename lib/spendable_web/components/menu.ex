defmodule SpendableWeb.Components.Menu do
  @moduledoc """
  The `SpendableWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `SpendableWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import SpendableWeb.Components.Accordion, only: [accordion: 1]
  import SpendableWeb.Components.Button, only: [button_link: 1]
