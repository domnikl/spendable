defmodule SpendableWeb.Components.MishkaComponents do
  defmacro __using__(_) do
    quote do
      ...
      import SpendableWeb.Components.Badge,
        only: [badge: 1, hide_badge: 1, hide_badge: 2, show_badge: 1, show_badge: 2]

      import SpendableWeb.Components.Banner,
      ...
      import SpendableWeb.Components.Carousel, only: [carousel: 1]
      ...
      import SpendableWeb.Components.Clipboard, only: [clipboard: 1]
      ...
      import SpendableWeb.Components.Drawer,
      ...
      import SpendableWeb.Components.Gallery,
      ...
      import SpendableWeb.Components.Layout, only: [flex: 1, grid: 1]
      ...
      import SpendableWeb.Components.Progress,
      ...
      import SpendableWeb.Components.Tabs,
