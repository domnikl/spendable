defmodule SpendableWeb.Components.NativeSelect do
  @moduledoc """
  The `SpendableWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `SpendableWeb.Components.NativeSelect`
