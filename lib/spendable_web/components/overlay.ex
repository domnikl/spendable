defmodule SpendableWeb.Components.Overlay do
  @moduledoc """
  The `SpendableWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `SpendableWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
