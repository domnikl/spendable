defmodule SpendableWeb.Components.RadioCard do
  @moduledoc """
  The `SpendableWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
