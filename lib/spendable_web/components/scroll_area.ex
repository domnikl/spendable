defmodule SpendableWeb.Components.ScrollArea do
  @moduledoc """
  The `SpendableWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
