defmodule SpendableWeb.Components.Spinner do
  @moduledoc """
  The `SpendableWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `SpendableWeb.Components.Spinner` module enables developers to provide
