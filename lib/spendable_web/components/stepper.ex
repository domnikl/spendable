defmodule SpendableWeb.Components.Stepper do
  @moduledoc """
  The `SpendableWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `SpendableWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
