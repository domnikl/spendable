defmodule SpendableWeb.Components.Tabs do
  @moduledoc """
  `SpendableWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import SpendableWeb.Components.Badge, only: [badge: 1]
