defmodule SpendableWeb.UserAuthTest do
  use SpendableWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Spendable.Users
  alias SpendableWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SpendableWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SpendableWeb.Endpoint.subscribe(live_socket_id)
